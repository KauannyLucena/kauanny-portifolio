  ...
  return (
    <>
      {isMobile ? (
        ...
        <header className="w-full bg-[#0a0f14] border-b border-[#010811CC] h-20 flex items-center justify-center px-6 overflow-hidden fixed z-[9999]">
          <div className="w-full flex justify-end max-w-[1200px]">
            <nav className="flex gap-6 text-[24px] text-[#071C36] font-bold tracking-wide">
              <NavItem href="#" label="INÍCIO" />
              <NavItem href="#" label="SOBRE" />
              <NavItem href="#" label="PROJETOS" />
              <NavItem href="#" label="CONTATO" />
